...
public class DeclarationForm extends AbstractPage {
    ...
    @FindBy(xpath = "//*[contains(@class,'ui-pnotify-title')]")
    ...
    /**
     * Get value for field with ID
     * Checked Checkbox is going to have 'X', UnChecked -  '' [empty String]
     *
     * @param id
     * @return String
     */
    ...
    public boolean warningAlertIsPresent() {
        WebDriverHelper.waitForElementVisibility(driver, warningAlert, AbstractPage.ELEMENT_APPEAR_TIMEOUT);
